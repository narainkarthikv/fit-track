  ...
  return (
    <section className="cta position-relative text-white text-center py-5">
        ...
        <div className="container position-relative">
            ...
            <p className="lead mb-4 fs-5 text-shadow">Join thousands of fitness enthusiasts who trust
                <strong>Fit-Track</strong>
                to monitor their workouts, track progress, and achieve their goals every day.</p>
            <Link
                to={isLoggedIn
                ? "dashboard"
                : "signup"}
